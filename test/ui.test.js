...
describe('UI Testing using Selenium', function () {
    ...
    it('should load the login page', async function () {
        const loginPagePath = 'file:///C:/Users/hanif/Documents/# PPMPL/Praktikum 4/loginPage.html'; // Pastikan path ini benar
    ...
    it('should handle failed login attempts', async function () {
        await driver.get('file:///C:/Users/hanif/Documents/# PPMPL/Praktikum 4/loginPage.html'); // Reload the login page
